	...
	Properties
	{
		...
		SubShader
		{
			...
			Pass
			{
				...
				// required to keep compatibility with Unity 2020 since shadows_cascade and shadows keywords must be in different multi_compile lines in 2020 while they're part of same multi_compile in 2021
